<div>
    <div class="flex flex-wrap flex-row">
        ...
        <p class="text-xl font-bold mt-3 mb-5">Resumo</p>
      </div>                                                    
<div class="flex-shrink max-w-full px-4 w-full sm:w-1/2 lg:w-1/4 mb-6">
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
        <div class="pt-6 px-6 relative text-sm font-semibold">
              ...
              <div class="flex flex-row justify-between px-6 py-4">
                ...
                <h2 class="self-center text-3xl">{{ $totalExpense }}</h2>
              </div>     
  </div>
</div>
<div class="flex-shrink max-w-full px-4 w-full sm:w-1/2 lg:w-1/4 mb-6">
        ...
        <div class="pt-6 px-6 relative text-sm font-semibold">
          Créditos                
              ...
              <div class="flex flex-row justify-between px-6 py-4">
                ...
                <h2 class="self-center text-3xl">{{number_format($totalCredits, 2 ,',', '.') }}</h2>
              </div>     
  </div>
</div>
        ...
        <div class="pt-6 px-6 relative text-sm font-semibold">
          Débitos                
              ...
              <div class="flex flex-row justify-between px-6 py-4">
                ...
                <h2 class="self-center text-3xl">{{number_format($totalDebits, 2 ,',', '.') }}</h2>
              </div>     
  </div>
</div>
        ...
        <div class="pt-6 px-6 relative text-sm font-semibold">
          Resultado             
              ...
              <div class="flex flex-row justify-between px-6 py-4">
                ...
                <h2 class="self-center text-3xl">{{ number_format($result, 2 ,',', '.') }}</h2>
              </div>     
  </div>
</div>
